...
check("'play the latest video from mkbhd' -> youtube (not Spotify)", r.route("play the latest video from mkbhd").tool == "youtube")
check("'play hermitcrafts latest video' -> youtube", r.route("play hermitcrafts latest video").tool == "youtube")
check("'play tum hi ho' still -> play_song", r.route("play tum hi ho").tool == "play_song")
